...
document, or books inference as cost of revenue. **Screen the rare tail.**
...
3. **The officer screen has poor recall.** SEC filings only name Section 16 officers, so a VP-level
   AI hire — often the more meaningful signal — is invisible. High precision, low recall; never read
