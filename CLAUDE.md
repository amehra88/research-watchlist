...
Watchlist: `config/watchlist.yaml` holds **158 distinct identifiers** across four tiers (177 tier entries; 19 tickers appear in both T2 and T3, so the entry count exceeds the distinct count):
