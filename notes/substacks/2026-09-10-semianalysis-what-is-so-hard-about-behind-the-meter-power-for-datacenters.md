...
source_email: <20260910142821.3.bdf2738addc7cb71@mg2.substack.com>
source_sender: SemiAnalysis <semianalysis@substack.com>
source_url: https://open.substack.com/pub/semianalysis/p/what-is-so-hard-about-behind-the
...
# [What is So Hard About Behind-The-Meter Power For Datacenters? Part 1](https://substack.com/app-link/post?publication_id=6349492&post_id=214173010&utm_source=post-email-title&utm_campaign=email-post-title&isFreemail=true&r=8ne7oq&token=eyJ1c2VyX2lkIjo1MjMwMjM3MjIsInBvc3RfaWQiOjIxNDE3MzAxMCwiaWF0IjoxNzg5MDUwNzA5LCJleHAiOjE3OTE2NDI3MDksImlzcyI6InB1Yi02MzQ5NDkyIiwic3ViIjoicG9zdC1yZWFjdGlvbiJ9.hbyyTNIcxbHFI5TYGq8YGQiOzpKRZIVouEBBsGhZJKw)

### Dumb Science Experiments vs. Money Printing Machines

Last year we were the first to call out [Onsite Gas Generation as the primary method adopted by AI Labs and Hyperscalers to solve power constraints](https://substack.com/redirect/08e13f1b-333c-4f07-b9c8-9e1fb9d0f83b?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA). Our positive view was far from being consensus: behind-the-meter primary power solutions have been called all sorts of names, such as “[science experiments](https://substack.com/redirect/e8da7532-c921-4861-a1ca-2804262911af?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)”, “[Dark Gigawatts](https://substack.com/redirect/e8da7532-c921-4861-a1ca-2804262911af?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)”, and “[literally the dumbest thing that human beings have ever attempted to do](https://substack.com/redirect/b52be360-4019-474d-8eeb-e0f3b80a130c?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)”!

But since then, that supply chain has witnessed a massive acceleration. Our [Energy Model](https://substack.com/redirect/7b3b3a2c-c5bd-4aaa-b6c3-db8aef2e5116?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) now tracks 75GW of firm, binding orders in the supply chain only for for behind-the-meter AI compute - of which ~20GW alone ordered in Q2 2026. What started as an Elon Musk experiment is now mainstream for every single AI Lab and hyperscaler. To be clear, this data does not include the hundreds of GWs of speculative, baseless announcements that many other analysts track in their numbers - we only focus on binding orders received by OEMs specifically serving BTM AI compute, tracked at the project-level.

The path from firm equipment order to delivered project is still long and challenging. There is substantial execution risk and that’s what we’ll focus on in this report. But the industry is more experienced than you’d think: by the end of the year, ~3GW of operational US datacenter IT capacity will be powered behind-the-meter, and that number will experience multiple straight years of triple-digit growth. Our Energy and Datacenter models account for all potential delays, as we’ve explained in depth in our piece [Stop Saying Half of 2026 US Datacenter Capacity is Canceled](https://substack.com/redirect/ad4886be-c00f-41e5-86bf-c3c24f6f9c93?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).
...
- Grid-parallel: Local generation and grid imports can both supply the datacenter. Exports are optional depending on the rights and connections.The relative sizes of the datacenter, its local generation, and its permitted grid imports can vary substantially. ERCOT’s Withdrawal-Limited Private Use Network, or WLPUN, framework expressly accommodates on-site generation reducing the transmission capacity a large load requires.Consider three illustrative configurations, each serving a 1,000 MW datacenter:Grid-led: 250 MW of local generation and a 1,000 MW import limit. Local generation offsets part of grid consumption; when producing 250 MW at full datacenter load, it leaves 750 MW to import.Plant-led, full-sized import connection: 1,200 MW of local generation and a 1,000 MW import limit. The plant can cover normal demand, while the import limit is large enough to accommodate the entire datacenter load.Plant-led, limited import connection: 1,200 MW of local generation and a 250 MW import limit. At full load, at least 750 MW must come from local resources. Losing all local generation would require replacement supply or at least 750 MW of load reduction.
...
In practice, this may change a lot over time. Many BTM projects plan for a grid connection and use BTM as a “bridge” - once the utility delivers the connection, the generators can shift into a backup role. We described this in depth the [Onsite Gas Deep Dive](https://substack.com/redirect/08e13f1b-333c-4f07-b9c8-9e1fb9d0f83b?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) as the most popular approach because electricity systems benefit from substantial economies of scale in both cost and reliability. xAI’s Colossus 1 in Memphis has taken this route.
...
Therefore, [we view](https://substack.com/redirect/cdbb7770-1ef6-49d8-9430-cddead34f7f8?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) the financing environment increasingly favorable towards BTM. In addition, datacenter developers are getting more sophisticated on energy and building their own world-class teams, and increasingly offering a full turnkey scope to offtakers, including the BTM plant.

## Stage 1: Permits

### The State Decides

With that said, let’s now tackle the physical challenges, starting with permits. We warned in the [Onsite Gas Deep Dive](https://substack.com/redirect/08e13f1b-333c-4f07-b9c8-9e1fb9d0f83b?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) that getting an air permit for onsite generation can take a year or more even in the fastest states, and that permits were already delaying some projects. In this section, we outline the varying permitting intensity by state, and how some developers have come up with creative solutions to circumvent permitting blockers.
...
- Exempt as a nonroad engine: A portable engine that stays on site under 12 monthsSits outside stationary-source permitting. Works for reciprocating engines only: any turbine of 10 million Btu an hour or more falls under a federal emission standard, confirmed by EPA’s [January 2026 turbine rule](https://substack.com/redirect/4051424a-8022-4bec-a3c1-b064a549f17e?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA). Mississippi exempted xAI’s trailer-mounted Southaven turbines under a state rule; that decision is being challenged in federal court; [40 CFR 1068.30](https://substack.com/redirect/5996b218-fa97-4721-b6dd-f2ae4a50b7cc?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).

- Minor New Source Review (NSR): PTE below every major thresholdA construction permit from the state or county, which sets the exemption cutoffs and how much modeling is needed. Public comment of at least 30 days. A plant that accepts an enforceable cap on hours or fuel to stay under the lines is a “synthetic minor”; changing that cap later triggers a full major-source review as if the plant were new; [40 CFR 51.160 to 51.161](https://substack.com/redirect/58e7e2e0-94a4-4542-9050-59f9c46eb3b0?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA); [40 CFR 52.21(r)(4)](https://substack.com/redirect/24f73ba8-acfc-46ef-aa16-85d4c9a1a25c?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).

- Prevention of Significant Deterioration (PSD), the major-source review: PTE of 250 tons a year of any pollutant. 100 tons for 28 listed industries; EPA reads “steam electric plant” to cover combined-cycle plants, while simple-cycle plants are treated as unlisted and so face the 250-ton limit.Usually issued by the state. Once major for one pollutant, the plant applies Best Available Control Technology to every pollutant above the significance rates (40 tons of NOx, 100 of CO), models its air-quality impact, usually supplies a year of monitoring data, and takes at least 30 days of public comment. The Clean Air Act requires a decision within a year of a complete application ([section 165(c)](https://substack.com/redirect/b16715d1-a7a1-448b-aa74-6f8497c3f6f4?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)); no national data on actual times exists; [40 CFR 52.21](https://substack.com/redirect/24f73ba8-acfc-46ef-aa16-85d4c9a1a25c?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).

- Nonattainment NSR: The area fails a federal air standard for the pollutant. It replaces PSD for that pollutant; PSD still applies to the rest.The limit falls to 100 tons a year, then to 50, 25 or 10 tons of NOx and VOC as an ozone area is rated serious, severe or extreme ([Clean Air Act 182](https://substack.com/redirect/a20e0189-b487-49e1-a853-d357c9804af8?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)). The plant must meet the Lowest Achievable Emission Rate and buy offsetting cuts from other sources in the same area, at 1.1 to 1.5 tons per ton. Location sets the line: Dallas and Houston sit at 25 tons, Chicago, Salt Lake City and Las Vegas at 50, Northern Virginia and Phoenix at 100 ([EPA Green Book](https://substack.com/redirect/176a298b-ef06-437b-957e-39907e30a7d0?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)); [40 CFR 51.165](https://substack.com/redirect/d14f336f-aa1c-4991-a9f3-0f715e1e113d?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).

- Title V operating permit: PTE of 100 tons a year or more, on top of whichever construction permit applies.Applied for within 12 months of commissioning. Gathers every requirement into one enforceable document with a five-year term. EPA gets 45 days to object and the public 60 days to petition. Adds monitoring, reporting and fees, and sets no new emission limits of its own; [40 CFR 70.2](https://substack.com/redirect/1a310385-48cc-4c69-8aed-884f5a6ff20f?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).
...
- Federal emission standards apply whatever the permit tier. The [January 2026 rule](https://substack.com/redirect/4051424a-8022-4bec-a3c1-b064a549f17e?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) sets a 5 ppm NOx floor for new large turbines running base load. That means selective catalytic reduction from day one.
...
In our [Onsite Gas Deep Dive](https://substack.com/redirect/08e13f1b-333c-4f07-b9c8-9e1fb9d0f83b?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) we went through the new types of technology and incumbent manufacturers, so you can go through the different types of equipment available to datacenter operators in that article.

Since writing in December 30, 2025 article, the three broad categories have remained unchanged:

- Gas turbines (GTs):industrial gas turbines (IGTs), smaller, heavier machines in the tens of megawatts;aeroderivatives (aeros), jet engines repackaged for power in the 30 to 115 MW range and able to ramp in 5 to 8 minutes; andheavy-duty frame turbines of roughly 400 MW, with increased fuel efficiency when put into a combined cycle with steam turbines.

- Reciprocating internal combustion engines (RICEs), or “recips”:high-speed engines (1,500 to 1,800 rpm) of roughly 0.5 to 4.5 MW per unit, such as INNIO’s Jenbacher Type 6 and Caterpillar’s G3520; andmedium-speed engines (500 to 1,000 rpm) of roughly 5 to 20 MW, such as Wärtsilä’s 34SG, 31SG and 50SG, INNIO’s J920 and Everllence’s 51/60G.
...
Our labor market modeling in [The Wild Wild West of LEGO Datacenters](https://substack.com/redirect/842779a6-3300-47db-920d-0f7d8b746b44?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) sized the 2027 gap at 288,000 workers, based on our Labor Model included in [our Industrials Model](https://substack.com/redirect/d540157b-90cd-44fa-bc65-e6c3a5b237c0?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA). Electricians are the largest trade at about 30% of site hours, drifting toward 40% by 2030 as liquid cooling adds mechanical work.
...
This is why “labor-light” power solutions are increasingly attractive to end-customers. [As the US grid runs out of power & headroom in 2028](https://substack.com/redirect/cdbb7770-1ef6-49d8-9430-cddead34f7f8?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA), these solutions will be the primary way to solve datacenter power constraints.
