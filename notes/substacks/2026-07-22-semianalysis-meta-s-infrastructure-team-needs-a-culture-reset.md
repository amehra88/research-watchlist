...
source_email: <20260722024134.3.444610a23f040707@mg-d0.substack.com>
source_sender: SemiAnalysis <semianalysis@substack.com>
source_url: https://open.substack.com/pub/semianalysis/p/metas-infrastructure-team-needs-a
...
# [Meta’s Infrastructure Team Needs A Culture Reset](https://substack.com/app-link/post?publication_id=6349492&post_id=207968269&utm_source=post-email-title&utm_campaign=email-post-title&isFreemail=true&r=8ne7oq&token=eyJ1c2VyX2lkIjo1MjMwMjM3MjIsInBvc3RfaWQiOjIwNzk2ODI2OSwiaWF0IjoxNzg0Njg4MzUyLCJleHAiOjE3ODcyODAzNTIsImlzcyI6InB1Yi02MzQ5NDkyIiwic3ViIjoicG9zdC1yZWFjdGlvbiJ9.4TX9wIWGE33aW5HYKtGRrL3qQcWea4-B9Mj-9X-j0bk)
...
In our [recent newsletter piece about Meta Superintelligence](https://substack.com/redirect/c4ce036f-c68c-4406-a075-f6e9e7a59bab?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA), we expressed reasons to be optimistic on Meta AI. MSL now has many of the right ingredients to catch up with Anthropic and OpenAI to return to the frontier. However, we also briefly alluded to cultural issues plaguing Meta’s infrastructure teams. This article will dive into how these cultural issues have manifested into expensive missteps, whether it be with acquisitions like Rivos or strange choices on hardware architecture.

We believe that Meta Infrastructure needs a cultural reset to better serve the Meta AI organization, especially the world class researchers who are at MSL. This is even more important as [Meta embarks on the path of selling its compute to outside customers](https://substack.com/redirect/4d50cd74-115b-426a-afd1-377f78e746e7?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA), not just serving captive internal users.
...
As we first [reported for clients](https://substack.com/redirect/94982d73-c789-434d-89a5-69e821b0d2cf?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA), around 30% of the Rivos engineers who joined Meta as part of the acquisition were let go in recent layoffs. Rivos co-founder Mark Hayter has already left. A number of former Rivos people have since departed Meta to join Gerard Williams’s new chip startup, Nuvacore, after their first tranche of RSUs vested in May. We believe that Rivos CEO and co-founder, Puneet Kumar, is also eyeing up an exit in a year or two when his shares in Meta fully vest. There is speculation he could join Rosaic Labs, a new chip startup co-founded by Amarjit Gill, an investor in Rivos and longtime collaborator with Puneet Kumar at SiByte, P.A. Semi, Apple and Agnilux.
...
However, we see this now popping up again with AMD’s MI450X. In AMD’s Q1 2026 earnings call, Lisa Su confirmed that AMD is providing Meta with a custom GPU based on the MI450. We have reported this for many months in the [Accelerator Model](https://substack.com/redirect/94982d73-c789-434d-89a5-69e821b0d2cf?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA). This custom Meta MI450 is a cut down version of the full MI450X with[half the compute silicon per package and number of HBM stacks. The HBM4 is also downgraded to 8-Hi HBM vs 12-Hi in](https://substack.com/redirect/68146c4f-cf80-4ce1-8ee5-ebdc78cb1251?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) the standard SKU. Given Meta’s Helios rack has the same number of switches, we assume that the amount of I/O is the same.
...
Meta choosing to cut this engineering marvel in half blunts the proposition completely. This chip configuration is intended for recsys workloads and was something that recsys infrastructure teams decided. However, the decision was made before TBD Lab was formed or could have its say. Given the significant compute and HBM deficiency, TBD has no interest in this system, nor is it attractive for external customers.
...
This is a public outcry from us for Meta and AMD to not waste the silicon and have better more efficient and cost effective AI infrastructure. If this change is made we think TBD would actually consider using MI450, driving significantly more traction and business.
