...
source_email: <20260709191614.3.902fb04a6d161c70@mg2.substack.com>
source_sender: SemiAnalysis <semianalysis@substack.com>
source_url: https://open.substack.com/pub/semianalysis/p/the-future-of-meta-superintelligence
...
# [The Future of Meta Superintelligence: A 1 Year Progress Update](https://substack.com/app-link/post?publication_id=6349492&post_id=206295088&utm_source=post-email-title&utm_campaign=email-post-title&isFreemail=true&r=8ne7oq&token=eyJ1c2VyX2lkIjo1MjMwMjM3MjIsInBvc3RfaWQiOjIwNjI5NTA4OCwiaWF0IjoxNzgzNjI0NzU3LCJleHAiOjE3ODYyMTY3NTcsImlzcyI6InB1Yi02MzQ5NDkyIiwic3ViIjoicG9zdC1yZWFjdGlvbiJ9.LKteXU7v61k0khx-49i1nx7mzhP6FBmme8-rWzd-pBU)
...
At the simplest level, there are three things you need to build a true frontier model: data, talent, and compute. We believe Meta is the only hyperscaler/neolab on track to be world class at all three and therefore has the best chance at catching up with Anthropic/OpenAI. We’ll explain why in full detail below, but as a teaser, here are the AI compute projections from our new [Tokenomics Model](https://substack.com/redirect/10053903-b6a6-425a-817a-2e0ccf71503e?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).
...
Reinforcement learning (RL) is the most important scaling law for improving AI capabilities today. The general idea is that instead of just predicting the next token, you teach the model how to complete entire tasks (e.g. fixing a bug in a codebase). Besides the tasks themselves, RL requires you to provide an environment for the model to complete the task in, tools the model can use to interact with the environment, and verifiers to check if the model’s answer is correct or not. For more background, see our [previous](https://substack.com/redirect/9270bfaf-e7fd-4cfe-87fc-f542d3b85894?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) [posts](https://substack.com/redirect/6537eb37-d04a-48b5-9f9d-98d76aada5eb?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA).

It is worth emphasizing that many AI insiders believe more RL environments/tasks are all we need to automate virtually all white-collar work. Here’s a quote from my roommate Sholto Douglas, a prominent Anthropic researcher, on the [Dwarkesh podcast](https://substack.com/redirect/a7be6756-8614-4b22-9886-283f57dcb219?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) last year:
...
The only way to calibrate task difficulty is to just have the AI try solving the problem a bunch of times and then iterating accordingly. It’s actually quite hard to make an RL task that’s sufficiently difficult for frontier models today, so your expert contractors normally spend their time making tasks more challenging. Mechanize, for example, only [expects](https://substack.com/redirect/2a9686ab-633f-4aa6-9f5e-f38287b1416b?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) the software engineers they pay $400k+ per year to make 1 good task per week.

Under these constraints, if you ask the average PE analyst to come up with a new financial modeling task from scratch because you want to RL your model to be better at Excel, you often end up with a contrived task that’s optimized for difficulty over realism. This is the main problem with benchmarks like OpenAI’s [GDPval](https://substack.com/redirect/a1d8f207-80a4-4897-a2e5-6a3e270a92a9?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) and Mercor’s [Apex](https://substack.com/redirect/98c4a410-a339-46c5-9bf6-eabd4c819f2e?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) suite (a good benchmark and a good RL env are roughly equivalent). If you read the tasks, you’ll see that most are unnaturally over-specified and don’t sound like something a human would actually ask an AI to do.
...
The fact that Meta is still nimble and aggressive enough to do this despite the PR hit and initial employee backlash is already quite impressive. Yes, they’ve since walked it back [slightly](https://substack.com/redirect/05d6e016-4db4-4200-9a08-4f4b1eb21c9f?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) by strengthening privacy protections and giving employees the option to pause the tracker for 30min, but we think these are very minor concessions.
...
Mercor recently [disclosed](https://substack.com/redirect/916a8212-8875-41fe-ae94-36401ff7027d?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) that they logged 2,517,000 expert hours on their platform in 2Q26, which is equivalent to ~4800 people working 40 hours a week. Meta is already in the same ballpark, and their average quality is likely higher. Additionally, they have another ~70k people to pull from if this experiment ends up being as valuable as we think.
...
Besides purchasing from data companies, Anthropic engineers have also been making coding tasks themselves for over a year. Frontier labs are willing to pay $5000+ for a single decent coding task. Mercor’s average pay rate recently [surpassed](https://substack.com/redirect/ebcf9953-e7bb-40de-ae9f-d2763fd8abc6?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) $100/hr, and the rate for SWEs is significantly above average. The top expert contractors at all of these data companies are making over 7 figures a year.
...
Compared to OpenAI and Anthropic, Meta has a balance sheet befitting a hyperscaler, and compared to Google, Meta doesn’t have a cloud business that’s aggressively trying to rent out as much compute as possible. Add in the fact that Zuck is willing to take [free cash flow negative](https://substack.com/redirect/671468ab-063c-4c83-8012-4f213efa1868?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA), and Meta should be able to bring up more internal AI compute than anyone else in the world.
...
It is important to note that a meaningful portion of this compute will be used for recommendation systems (RecSys) and generative ads. However, even if we remain conservative and only assign specific, high-profile Meta DC sites to MSL, their training compute is still comparable to OpenAI and Anthropic through 2026 and 2027. See our recent [newsletter](https://substack.com/redirect/31db90a9-ca96-4604-936c-c19d1d0c0a43?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) for a more detailed breakdown on Meta’s compute strategy and our [Tokenomics Model](https://substack.com/redirect/10053903-b6a6-425a-817a-2e0ccf71503e?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) for concrete numbers.

#### An unprecedentedly large compute ramp led by 5 titans

Much has been [written](https://substack.com/redirect/0ac3212d-defa-4906-957a-50a17d814cd8?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) about Colossus and Elon’s ability to bring enormous amounts of compute online quickly, but what Meta’s doing today is arguably even more impressive, as our [Datacenter Industry Model subscribers](https://substack.com/redirect/fc1ef94d-6df4-4c2f-bdec-e0ccf2d6cf28?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) have known for over a year.
...
In Iowa, Meta signed a 1GW lease with a leading datacenter operator ([as we flagged in June 2025 in our Datacenter Model](https://substack.com/redirect/fc1ef94d-6df4-4c2f-bdec-e0ccf2d6cf28?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)). As you can see from the satellite images below, they’ve gone from nothing to the full GW under construction in just 1 year.

At Prometheus—which is already partially operational today—Meta doesn’t quite have a full GW currently under construction, but they are fully embracing the scrappy tent DC design we called out in our previous MSL article. The Prometheus cluster also keeps expanding—from an initial ~1GW to now >3GW within two years. To understand how Meta achieves this, check out our [Datacenter Model](https://substack.com/redirect/fc1ef94d-6df4-4c2f-bdec-e0ccf2d6cf28?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA). We have building-level tracking of all five Titans, and are the first to call out any expansions with precise monthly timelines. Some of these facilities use behind-the-meter power and we track the exact type of system and flag permitting risk.
...
Last year, Meta became famous for offering AI researchers compensation packages that would make Patrick Mahomes jealous. After spending $14B to acquire Alexandr Wang and another $1B+ to buy out Nat Friedman and Daniel Gross’ venture fund, it was [reported](https://substack.com/redirect/ac0c69e4-cbb5-4d39-a836-4f146c80773c?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) that Meta had poached at least 14 researchers by the end of June 2025. Most of these people were ex-OpenAI, but there were a handful from Anthropic and Google as well. Some big names include Shengjia Zhao, Trapit Bansal, Joel Pobar, and Jack Rae.
...
MSL’s not just hiring members of technical staff either. This January, they brought on [Dina Powell McCormick](https://substack.com/redirect/823b2604-8060-455a-9f24-8f32f50b6f15?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)—a well connected finance bro and former advisor to both Trump and W Bush—as President and Vice Chairman to help build out their compute fleet. In the same vein, they also poached the 3 musketeers from OpenAI’s compute team (Pete Hoeschele, Anuj Saharan, Shamez Hemani) in April, though 1 of them has already quit because of Meta’s culture issues on the infrastructure org.
