...
source_email: <20260702172538.3.9d401ee7ac1e8d53@mg-d1.substack.com>
source_sender: SemiAnalysis <semianalysis@substack.com>
source_url: https://open.substack.com/pub/semianalysis/p/ectc2026
...
# [EMIB-T Roadmap, Custom HBM, HBM4 Packaging Challenges, Microfluidic Cooling, Photonic Interconnects, and More](https://substack.com/app-link/post?publication_id=6349492&post_id=203326093&utm_source=post-email-title&utm_campaign=email-post-title&isFreemail=true&r=8ne7oq&token=eyJ1c2VyX2lkIjo1MjMwMjM3MjIsInBvc3RfaWQiOjIwMzMyNjA5MywiaWF0IjoxNzgzMDEzMzQ1LCJleHAiOjE3ODU2MDUzNDUsImlzcyI6InB1Yi02MzQ5NDkyIiwic3ViIjoicG9zdC1yZWFjdGlvbiJ9.CiWmf_sbxIDK5i0BhcOqdMSo3s1TxLbpSJNrMO-Ifak)
...
Intel was the largest corporate presenter at ECTC. The key disclosure was EMIB-T. This is the next generation of EMIB with through-silicon vias (TSVs). After the [initial announcement](https://substack.com/redirect/682caed0-119c-4ed8-8a1f-2833af5f53ce?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA), Intel has filled in more of the architecture and roadmap, including tighter bump pitch, larger packages and on-bridge capabilities. Their disclosures show why EMIB-T is expected to be used in Google’s TPU v9, and why it is the most credible alternative to TSMC’s CoWoS platform for large-package AI accelerators.
...
EMIB-T is still behind TSMC’s CoWoS platform on several vectors. TSMC has already deployed DTC/eDTC integration and is further along on integrated voltage regulators and [active local silicon interconnect (LSI](https://substack.com/redirect/53455649-6a9d-440b-a12f-beddf1716f67?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)). EMIB-T narrows the gap, but Intel is still catching up to an ecosystem that has been executing in volume for years.
...
In the near term, [vertically stacked optical engines like TSMC’s COUPE](https://substack.com/redirect/78c27c92-b495-4c97-b9fb-55c40c983f3a?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) are more achievable than OMIB-style connections or a full photonic interposer. Marvell connects the EIC and PIC using microbumps at 50 µm pitch, then mounts the resulting engine to either the package substrate or an interposer.
...
Marvell tested an optical engine using a 5 nm (likely TSMC N5) EIC, with four 56 Gb/s TX-RX pairs for 224 Gb/s in each direction. The design uses [electro-absorption modulators (EAMs)](https://substack.com/redirect/f4a373f2-169f-474f-bfb5-4db4158284c5?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA) instead of the micro-ring modulators (MRMs) preferred by other companies, citing better thermal stability and a wider operating wavelength range. While these advantages are real, we believe that EAMs will prove difficult to manufacture at scale.

#### [Co-Packaged Optics (CPO) Book – Scaling with Light for the Next Wave of Interconnect](https://substack.com/redirect/cae0b703-b804-4e42-8ddb-1c9648269a21?j=eyJ1IjoiOG5lN29xIn0.bqmJ9TjykdtTXCviJ3jD2X5vxhprRGd5tpCaC89FQIA)
