...
■
We launched our Intel Arc A-series GPUs, also known as Alchemist, which offer industry-leading advanced features, including hardware accelerated ray tracing, X e Super Sampling AI-driven upscaling technology, and Intel ® Deep Link technology.
■
We launched Ponte Vecchio, the first X e -based GPU optimized for high-performance computing and AI workloads.
MD&A
33
Table of Contents
Market and Business Overview
...
Additionally, the COVID-19 pandemic and recent geo-political issues have highlighted the world’s dependence on semiconductors and the vulnerable supply chain that underpins the industry. Approximately 88% of the world’s semiconductor manufacturing capacity is in Asia, and only 4.5% is in the US 1 .
Products and Competition
...
1 Source: 2022 Gartner Worldwide Foundry Capacity Forecast by Region, 2020-2026.
2 Source: TrendForce.
MD&A
37
Table of Contents
...
Years Ended
(In Millions, Except Per Share Amounts) December 31, 2022 December 25, 2021 December 26, 2020
Amount % of Net
...
When assessing our current sources of liquidity, we include our total cash and investments 1 as shown in the following table:
